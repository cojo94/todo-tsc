...
let todos: TodoItem[] = [
    new TodoItem(1, "Buy Beer"), new TodoItem(2, "Get Shoes"),
    new TodoItem(3, "Collect Tickets"), new TodoItem(4, "Call Dad", true)];

let collection: TodoCollection = new JsonTodoCollection("Conny", todos);
