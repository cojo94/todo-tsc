...
let todos = [
    new todoItem_1.TodoItem(1, "Buy Beer"), new todoItem_1.TodoItem(2, "Get Shoes"),
    new todoItem_1.TodoItem(3, "Collect Tickets"), new todoItem_1.TodoItem(4, "Call Dad", true)
];
let collection = new jsonTodoCollection_1.JsonTodoCollection("Conny", todos);
